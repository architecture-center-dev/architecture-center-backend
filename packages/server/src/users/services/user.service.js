...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.save = function (email, password) {
        return __awaiter(this, void 0, void 0, function () {
            var userAlreadyExisits, user, bcrypt, hash;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userRepository.findOne({ where: { email: email } })];
                    case 1:
                        userAlreadyExisits = _a.sent();
    ...
    UserService.prototype.findUserByAndPassword = function (email, password) {
        return __awaiter(this, void 0, void 0, function () {
            var user, bcrypt, isPasswordMatching;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userRepository.findOne({ where: { email: email } })];
                    case 1:
                        user = _a.sent();
                        bcrypt = require('bcrypt');
                        isPasswordMatching = bcrypt.compareSync(password, user.password);
                        return [2 /*return*/, isPasswordMatching ? user : null];
                }
            });
        });
    };
