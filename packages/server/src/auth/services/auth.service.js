...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.validateUser = function (username, pass) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.usersService.findUserByAndPassword(username, pass)];
                    case 1:
                        user = _a.sent();
                        if (user !== null) {
    ...
    AuthService.prototype.login = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var payload, userAuthenticated;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        payload = { username: user.username, sub: user.userId };
                        return [4 /*yield*/, this.validateUser(user.username, user.password)];
                    case 1:
    ...
    AuthService.prototype.registerUser = function (userDto) {
        var password = userDto.password, confirmPassword = userDto.confirmPassword;
