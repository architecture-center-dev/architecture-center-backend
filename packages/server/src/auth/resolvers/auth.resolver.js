...
var oauth_token_type_1 = require("../../users/Entities/oauth-token.type");
var AuthResolver = /** @class */ (function () {
    function AuthResolver(authService) {
        this.authService = authService;
    }
    AuthResolver.prototype.login = function (username, password) {
        return __awaiter(this, void 0, void 0, function () {
            var user, authResult, oauth;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        authResult = _a.sent();
                        oauth = new oauth_token_type_1.OauthTOken();
    ...
    __decorate([
        graphql_1.Mutation(function (returns) { return oauth_token_type_1.OauthTOken; }, { nullable: true }),
